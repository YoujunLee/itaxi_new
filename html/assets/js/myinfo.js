 ...
 var data;
  $(document).ready(function () {
    myurl=window.location.protocol + '//' + window.location.host + '/assets/php/myinfo.php';
        $.ajax({
            dataType: "json",
            url: myurl,
            data: data,
      ...
      var form=$('<form class="form" action="./assets/php/change_info.php" method="post">').appendTo(information);
