   ...
   myurl='http://52.78.208.153/assets/php/login.php';
       $.ajax({
           ...
           success: function (data) {
            ...
            var input_id=$("<input class='input100' type='text' name='hisnetid' value='"+data[0]+"'disabled required>").appendTo(div_wrap_id);
            ...
            var input_stuid=$("<input class='input100' type='text' name='stuid' value='"+data[1]+"'disabled required>").appendTo(div_wrap_stuid);
            ...
            var input_name=$("<input class='input100' type='text' name='name' value='"+data[2]+"'disabled required>").appendTo(div_wrap_name);
